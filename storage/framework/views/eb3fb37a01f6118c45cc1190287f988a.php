...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->get('Mandi Consumers'); ?>
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/mandi/consumer')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->fld_total): ?>
                                                        <a class=""
                                                            href="<?php echo e(route('mandi.consumersales', ['cid' => $record->fld_cid])); ?>">
                                                            <i class="ri-eye-line"></i></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(route('mandi.consumersales.addnew', ['cid' => $record->fld_cid])); ?>"
                                                    ...
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form
                                                            ...
                                                            action="<?php echo e(route('mandi.consumer.destroy', $record->fld_cid)); ?>"
                                                            method="GET">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mandi/consumer/index.blade.php ENDPATH**/ ?>