                         ...
                         <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="fld_sale_type" required>
                                        ...
                                        <option value="1" <?php if($project->fld_type == 1): ?> selected <?php endif; ?>>Van</option>
                                        <option value="2" <?php if($project->fld_type == 2): ?> selected <?php endif; ?>>Mandi</option>
                                        <option value="3" <?php if($project->fld_type == 3): ?> selected <?php endif; ?>>Mela</option>
                                        <option value="4" <?php if($project->fld_type == 4): ?> selected <?php endif; ?>>Branding</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="hidden"  name="fld_sale_type" value="<?php echo e($project->fld_sale_type); ?>">
                    <!-- <div class="col-md-12">
                        <div class="mb-3">
...
<?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/project/edit.blade.php ENDPATH**/ ?>