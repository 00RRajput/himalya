        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/van/purchase')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <a class=""
                                                            href="<?php echo e(route('van.purchasedetails.items', $record->fld_prid)); ?>">
                                                            <i class="ri-eye-line"></i></a>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(route('van.purchasedetails.delete', $record->fld_prid)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/purchasedetail.blade.php ENDPATH**/ ?>