<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Purchase Details'); ?>
                        ...
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="table-row" data-row-id=<?php echo e($record->fld_prid); ?>>

                                            <td class="td">
                                                <span class="row_product_id"
                                                    data-product-name="<?php echo e($record->fld_product_name); ?>"
                                                    data-product-id=<?php echo e($record->fld_product_id); ?>>
                                                    <?php echo e($record->fld_product_name); ?>- <?php echo e($record->fld_selling_price); ?>

                                                    (MRP Rs.<?php echo e($record->fld_mrp); ?>)
                                                </span>
                                            </td>
                                            <td class="td">
                                                <input id="product_qty_<?php echo e($record->fld_prid); ?>"
                                                    data-record-id="<?php echo e($record->fld_prid); ?>"
                                            ...
                                            <td class="td"><input readonly id="product_total_<?php echo e($record->fld_prid); ?>"
                                            ...
                                            <td>
                                                <a class="bx bx-trash removeProduct" href="javascript:void(0)"
                                                    data-id="<?php echo e($record->fld_prid); ?>"></a>
                                            </td>
                                        </tr>
                                        <?php
                            ...
                            <table class="table align-middle table-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <input class="form-control" id="date" type="date" name="fld_date"
                                                value="<?php echo e($purchases->fld_date); ?>" />
                                        </th>
                                        <th>
                                            <label>Total</label>
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="hidden" id="fld_prid" value="<?php echo e($purchases->fld_prid); ?>" />
                                            <input type="hidden" id="fld_project_id"
                                                value="<?php echo e($purchases->fld_project_id); ?>" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="<?php echo e($purchases->fld_mobile_id); ?>" />
        ...
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $('#purchase-details tbody tr.table-row').each(function() {
                    ...
                    var item = {
                        "fld_prid": $("#fld_prid").val(),
                        "fld_mobile_id": $("#fld_mobile_id").val(),
                        "fld_project_id": $("#fld_project_id").val(),
                ...
                $.ajax({
                    url: "<?php echo e(route('purchasedetails.item.udate')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/purchasedetailItems.blade.php ENDPATH**/ ?>