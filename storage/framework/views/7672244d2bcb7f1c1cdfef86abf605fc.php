<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Outlets'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('titleHeading'); ?>
            Total OutLets: <?php echo e(count($outlets)); ?> 
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/branding/outlets')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                    ...
                    <div>
                            ...
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                <thead class="text-muted">
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Total Recce</th>
                                        <th class="text-uppercase">Location</th>
                                        <th class="text-uppercase">Contact User</th>
                                        <th class="text-uppercase">Contact Number</th>
                                        <th class="text-uppercase">Direct Install </th>
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            
                                            <td class="td"><?php echo e($record->fld_outlet); ?></td>
                                            <td class="td"><?php echo e($record->recce_count); ?></td>
                                            ...
                                            <td class="td">
                                                <?php if($record->fld_direct_install): ?>
                                                yes 
                                                <?php else: ?>
                                                No
                                                <?php endif; ?>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <div class="pagination-wrap hstack gap-2" style="display: flex;">
                                <?php echo e($outlets->appends(request()->except('page'))->links()); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/branding/outlets.blade.php ENDPATH**/ ?>