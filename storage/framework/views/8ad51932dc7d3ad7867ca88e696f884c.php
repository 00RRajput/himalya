<form action="<?php echo e(route('clients.update', $client->fld_cid)); ?>" method="POST" name="update_new_client">
    <?php echo method_field('PUT'); ?>
    <?php echo csrf_field(); ?>

    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Edit <?php echo e($client->fld_name); ?></h4>
        </div>
...
unset($__errorArgs, $__bag); ?>">
                                <input class="form-control" value="<?php echo e(old('fld_name', $client->fld_name)); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch"
                                    id="flexSwitchCheckChecked" <?php if($client->fld_name === 1): echo 'checked'; endif; ?> value="1"
                                    name="status">
...
<?php /**PATH /home/u951376346/domains/nebulacrm.in/public_html/himalaya/resources/views/client/edit.blade.php ENDPATH**/ ?>