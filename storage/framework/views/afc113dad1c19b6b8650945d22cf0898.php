                        ...
                        <div class="table-responsive table-card">
                            ...
                            <table class="table align-middle table-nowrap">
                                ...
                                <tfoot>
                                    <tr> 
                                        <td colspan="5">
                                            <input type="hidden" id="fld_rsid"
                                                value="<?php echo e($retailSale->fld_rsid ?? 0); ?>" />
                                            <input type="hidden" id="fld_rid" value="<?php echo e($retailer->fld_rid ?? 0); ?>" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="<?php echo e($retailSale->fld_mobile_id ?? 0); ?>" />
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3, 5])): ?>
                                                <a class="btn btn-success" id="updateItems"
                                                    href="javascript:void(0)">Submit</a>
                                            <?php endif; ?>
                                            <a class="btn btn-danger" href="<?php echo e(route('van.retailers')); ?>">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('salesreport.retailsales.createNewOrder')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/addNewOrder.blade.php ENDPATH**/ ?>