                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <input type="hidden" id="fld_rid" value="<?php echo e($retailer->fld_rid); ?>" />
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('mandi.retailsales.createNewOrder')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mandi/addNewOrder.blade.php ENDPATH**/ ?>