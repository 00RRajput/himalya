                ...
                <div class="p-3">
                    <div class="gap-2 d-flex justify-content-end ">
                        <?php if(in_array(Auth::user()->fld_role, [1])): ?>
                            <a class="btn  btn-success btn-sm" href="<?php echo e(url('master/route-plans')); ?>"
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="td"><?php echo e($record->attenUser->fld_name ?? 'NA'); ?></td>
                                            ...
                                            <td class="td"><?php echo e($record->project->fld_name); ?></td>
                                            <td class="td">
                                                <div class="d-flex gap-2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u951376346/domains/nebulacrm.in/public_html/himalaya/resources/views/report/routeplans.blade.php ENDPATH**/ ?>