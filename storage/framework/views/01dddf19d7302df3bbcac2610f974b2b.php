    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('master.update.routePlans', $routePlan->fld_rpid)); ?>" method="POST" name="add_new">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="text-end">
                                    ...
                                    <input class="form-control" type="hidden" readonly id="fld_tid"
                                        value="<?php echo e($routePlan->fld_tehsil_id); ?>" name="fld_tid" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/editRoutePlan.blade.php ENDPATH**/ ?>