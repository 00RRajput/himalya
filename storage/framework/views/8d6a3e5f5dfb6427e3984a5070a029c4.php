    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('master.store.routePlans')); ?>" method="POST" name="add_new">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/createRoutePlan.blade.php ENDPATH**/ ?>