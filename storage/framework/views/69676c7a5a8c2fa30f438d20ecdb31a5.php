<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Mandi Retailers'); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('mandi/retailers')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($record->order_count): ?>
                                                <?php echo e($record->order_count); ?> | Rs.<?php echo e($record->retail_sale_count_sum_fld_total); ?>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->retail_sale_count_sum_fld_total): ?>
                                                        <a href="<?php echo e(route('mandi.retailsales', ['rid' => $record->fld_rid])); ?>"
                                                            data-id="25000351"><i class="ri-eye-fill text-muted"></i>
                                                        </a>
                                                     <?php endif; ?>
                                                    <a href="<?php echo e(route('mandi.retailsales.addnew', ['rid' => $record->fld_rid])); ?>"
                                                        data-id="25000351"><i class="ri-add-box-fill text-muted"></i>
                                                    </a>
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(url('/mandi/retailer/delete/'.$record->fld_rid)); ?>"
                                                            method="GET">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mandi/retailers.blade.php ENDPATH**/ ?>