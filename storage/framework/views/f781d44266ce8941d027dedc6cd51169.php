<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Van Retailers'); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/van/retailers')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->retail_sale_count_sum_fld_total): ?>
                                                        <a href="<?php echo e(route('van.retailsales', ['rid' => $record->fld_rid])); ?>"
                                                    ...
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(url('retailer.delete/'.$record->fld_rid)); ?>"
                                                            method="DELETE">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/retailers.blade.php ENDPATH**/ ?>