                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <?php endif; ?>
                                            <a class="btn btn-danger" href="<?php echo e(route('van.consumer')); ?>">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('consumer.createNewOrder')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/consumer/addNewOrder.blade.php ENDPATH**/ ?>