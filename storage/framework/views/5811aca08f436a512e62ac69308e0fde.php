        <form action="<?php echo e(route('tehsil.store')); ?>" method="POST" name="add_new_record">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="<?php $__errorArgs = ['fld_tehsil'];
...
unset($__errorArgs, $__bag); ?>">
                                        <input class="form-control" value="<?php echo e(old('fld_tehsil')); ?>" type="text"
...
<?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/location/tehsil/create.blade.php ENDPATH**/ ?>