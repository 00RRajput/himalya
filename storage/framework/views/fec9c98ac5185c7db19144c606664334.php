    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('mandi.update.routePlans', $routePlan->fld_rpid)); ?>" method="POST" name="add_new">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="card-body">
                        <div class="live-preview">
                            <input type="hidden" name="fld_project_id" value="<?php echo e($routePlan->fld_pid); ?>">
                            <div class="row">
                                <!--end col-->
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="district_id" id="district_id"
                                        ...
                                        <?php $__currentLoopData = $destrict; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($dis->fld_did); ?>" <?php if($routePlan->fld_district_id == $dis->fld_did): echo 'selected'; endif; ?>>
                                                <?php echo e($dis->fld_district); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div> 
                                <div class="col-4 mb-3">
                                    <label for="fld_tid" class="form-control-label">Towns<sup>*</sup></label>
                                    <select name="fld_tid" id="fld_tid"
                                        class="form-control bg-light border-light flatpickr-input" required>
                                        ...
                                        <?php $__currentLoopData = $towns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $town): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($town->fld_tid); ?>" <?php if($routePlan->fld_town_id == $town->fld_tid): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-4 mb-3">
                                <label for="user_id" class="form-control-label">Mandi<sup>*</sup></label>
                                    <select id="mandi_id" name="mandi_id"
                                        ...
                                        <?php $__currentLoopData = $mandis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mandi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($mandi->fld_mid); ?>" <?php if($routePlan->fld_mandi_id == $mandi->fld_mid): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-4 mb-3">
                                <label for="user_id" class="form-control-label">Wholesalers<sup>*</sup></label>
                                    <select name="wholesaler_id" id="wholesaler_id"
                                        ...
                                        <?php $__currentLoopData = $wholesalers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($w->fld_wsid); ?>" <?php if($routePlan->fld_wsid == $w->fld_wsid): echo 'selected'; endif; ?>>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mandi/editRoutePlan.blade.php ENDPATH**/ ?>