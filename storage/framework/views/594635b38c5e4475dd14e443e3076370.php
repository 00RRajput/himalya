    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('branding.update.routePlans', $routePlan->fld_rpid)); ?>" method="POST" name="add_new">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="card-body">
                        <div class="live-preview">
                            <input type="hidden" value="<?php echo e($routePlan->fld_pid); ?>" name="fld_project_id">
                            <div class="row">
                                <!--end col-->
                                ...
                                <div class="col-4 mb-3">
                                <label for="state_id" class="form-control-label">Towns<sup>*</sup></label>
                                    <select name="town_id" id="town_id"
                                        ...
                                        <option value="<?php echo e($town->fld_tid); ?>" <?php if($routePlan->fld_town_id == $town->fld_tid): echo 'selected'; endif; ?>><?php echo e($town->fld_town); ?> </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-4 mb-3">
                                <label for="state_id" class="form-control-label">Outlets<sup>*</sup></label>
                                    <select name="outlet_id" id="town_id"
                                        class="form-control bg-light border-light flatpickr-input" required>
                                        <option value=""><?php echo app('translator')->get('All Outlets'); ?> </option>
                                        <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($outlet->fld_oid); ?>" <?php if($routePlan->fld_outlet_id == $outlet->fld_oid): echo 'selected'; endif; ?>><?php echo e($outlet->fld_outlet); ?> </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/branding/editRoutePlan.blade.php ENDPATH**/ ?>