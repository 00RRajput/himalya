<div class="row">
    <div class="col-lg-8">
        <div class="card" id="invoiceList">
            ...
            <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                <form action="<?php echo e(url('/location/village')); ?>" method="GET">
                    <div class="row g-3">
                        <!--end col-->
                        <div class="col">
                            ...
                            <tbody class="list form-check-all" id="">
                                <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="td"><?php echo e($record->tehsil->fld_tehsil); ?></td>
                                        <td class="td"><?php echo e($record->fld_village); ?></td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a class="ri-edit-line"
                                                    href="<?php echo e(route('village.edit', $record->fld_vid)); ?>"></a>

                                                <form action="<?php echo e(route('village.destroy', $record->fld_vid)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
    ...
    <div class="col-lg-4">
        <?php if(request()->route()->getName() === 'village.edit'): ?>
            <?php echo $__env->make('location.village.edit', [
                'districts' => $districts,
                'states' => $states,
                'village' => $village,
                'tehsils' => $tehsils,
        ...
        <?php else: ?>
            <?php echo $__env->make('location.village.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var request_tehsil_id = "<?php echo e(request('tehsil_id')); ?>"
            getLoads();
...
<?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/location/village/index.blade.php ENDPATH**/ ?>