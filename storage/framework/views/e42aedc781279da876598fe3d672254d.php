...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->get('Mandi Stockists'); ?>
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('mandi.stockists')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->purchase_sum_fld_total): ?>
                                                        <a
                                                            href="<?php echo e(route('mandi.purchasedetails.items', $record->fld_sid)); ?>">
                                                            <i class="ri-eye-line"></i></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(route('mandi.stockists.addneworder', ['sid' => $record->fld_sid])); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mandi/stockists.blade.php ENDPATH**/ ?>