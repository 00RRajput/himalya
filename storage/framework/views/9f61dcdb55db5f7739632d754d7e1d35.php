                            ...
                            <div class="col">
                                <select name="project_id" id="project_id"
                                    ...
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($project->fld_pid == 1): ?><option value="<?php echo e($project->fld_pid); ?>" <?php if(session('project_id') == $project->fld_pid || request('project_id') == $project->fld_pid): echo 'selected'; endif; ?>>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->fld_total): ?>
                                                        <a class=""
                                                            href="<?php echo e(route('van.consumersales', ['cid' => $record->fld_cid])); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/consumer/index.blade.php ENDPATH**/ ?>