<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Retail Sale Details'); ?>
                        ...
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="table-row" data-row-id=<?php echo e($record->fld_mrsiid); ?>>
                                            ...
                                            <td class="td">
                                                <input id="product_qty_<?php echo e($record->fld_mrsiid); ?>"
                                                    data-record-id="<?php echo e($record->fld_mrsiid); ?>"
                                            ...
                                            <td class="td"><input readonly id="product_total_<?php echo e($record->fld_mrsiid); ?>"
                                            ...
                                            <td>
                                                <?php if(in_array(Auth::user()->fld_role, [1, 3, 5])): ?>
                                                    <a class="bx bx-trash removeProduct" href="javascript:void(0)"
                                                        data-id="<?php echo e($record->fld_mrsiid); ?>"></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php
                            ...
                            <table class="table align-middle table-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <input class="form-control" id="date" type="date" name="fld_date"
                                                value="<?php echo e($retailSale->fld_date); ?>" />
                                        </th>
                                        <th>
                                            <label>Total</label>
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="hidden" id="fld_rsid" value="<?php echo e($retailSale->fld_rsid); ?>" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="<?php echo e($retailSale->fld_mobile_id); ?>" />
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3, 5])): ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                console.log($('#purchase-details tbody tr.table-row'));
                ...
                $.ajax({
                    url: "<?php echo e(route('mandi.retailsales.details.update')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mandi/retailsaledetails.blade.php ENDPATH**/ ?>