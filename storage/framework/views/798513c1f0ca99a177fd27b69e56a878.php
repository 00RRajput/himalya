                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <input type="hidden" id="fld_sid" value="<?php echo e($stockist->fld_sid ?? 0); ?>" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="<?php echo e($stockist->fld_mobile_id ?? 0); ?>" />
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3, 5])): ?>
                                                <a class="btn btn-success" id="updateItems"
                                                    href="javascript:void(0)">Submit</a>
                                            <?php endif; ?>
                                            <a class="btn btn-danger" href="<?php echo e(route('van.stockists')); ?>">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('stockists.save.addneworder')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/stockiestAddNewOrder.blade.php ENDPATH**/ ?>