<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Consumer Sales'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('titleHeading'); ?>
            Mela Consumer Sales (Total Orders: <?php echo e($records->total()); ?> , Order Value: ₹ <?php echo e($total_order_value); ?>)
        <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->get('Mela Consumer Sales'); ?>
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('mela/consumer-sales')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="d-flex gap-2">
                                    ...
                                    <a class="btn btn-secondary col ml-1"
                                        href="<?php echo e(url('mandit/consumer-sales')); ?>">Reset</a>
                            ...
                            <table class="table align-middle table-nowrap" id="">
                                <thead class="text-muted">
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Consumer Name</th>
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($record->consumer_name); ?></td>
                                            <td><?php echo e($record->mobile_no); ?></td>
                                            ...
                                            <td><?php echo e($record->fld_village); ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a class=""
                                                        href="<?php echo e(route('mela.consumersales.details', $record->fld_mcsid)); ?>">
                                                        <i class="ri-eye-line"></i></a>
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(route('mela.consumerSales.delete', $record->fld_mcsid)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
        ...
        $(document).ready(function() {
            ...
            function getUsers() {
                ...
                if (id) {
                    ...
                    $.ajax({
                        url: `/sales-report/consumer-sales/get-state-wise-users/${id}`,
                        success: function(result) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mela/consumersales.blade.php ENDPATH**/ ?>