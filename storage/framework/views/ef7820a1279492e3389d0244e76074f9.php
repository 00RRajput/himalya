...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->get('Mela Consumers'); ?>
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/mela/consumer')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($record->fld_village); ?>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->fld_total): ?>
                                                        <a class=""
                                                            href="<?php echo e(route('mela.consumersales.details', $record->fld_mcid)); ?>">
                                                            <i class="ri-eye-line"></i></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(route('mela.consumersales.addnew', ['mcid' => $record->fld_mcid])); ?>"
                                                    ...
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form
                                                            ...
                                                            action="<?php echo e(route('mela.consumer.destroy', $record->fld_mcid)); ?>"
                                                            method="GET">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/mela/consumer/index.blade.php ENDPATH**/ ?>