                        ...
                        <div class="row g-3">
                            ...
                            <div class="col">
                                <div class="d-flex gap-2">
                                    ...
                                    <a class="btn btn-secondary col ml-1" href="<?php echo e(url('attendance')); ?>">Reset</a>
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="role_id"><?php echo e($record->attenUser->fld_name ?? 'NA'); ?></td>
                                            <td class="role_id"><?php echo e($record->state->fld_state ?? 'NA'); ?></td>
                                            <td class="role_id">
                                                <?php echo e(date(env('TIME_FORMAT', 'h:i a, ') . env('DATE_FORMAT'), strtotime($record->fld_datetime))); ?>
                                            ...
                                            <td><?php echo e($record->fld_comment); ?></td>
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                <td>

                                                    <form onsubmit="return confirm('Do you really want to delete?');"
                                                        action="<?php echo e(route('attendance.delete', $record->fld_aid)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u951376346/domains/nebulacrm.in/public_html/himalaya/resources/views/attendance.blade.php ENDPATH**/ ?>