...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('titleHeading'); ?>
            PURCHASE DETAILS (Total Orders: <?php echo e($records->total()); ?> , Order Value: ₹ <?php echo e($total_order_value); ?>)
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('purchase-details')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="td"><?php echo e(date(env('DATE_FORMAT'), strtotime($record->fld_date))); ?>

                                            </td>
                                            <td class="td"><?php echo e($record->fld_total); ?></td>
                                            <td>
                                                <?php echo e($record->stockist_firm_name); ?>
                                                ...
                                                <p class="text-muted mb-0"> <a
                                                    ...
                                                    <?php echo e($record->fld_district); ?></p>
                                            </td>
                                            <td class="td">
                                                <?php echo e($record->stockist_name ?? 'NA'); ?>

                                                <p class="text-muted"><?php echo e($record->stockist_number ?? 'NA'); ?></p>
                                            </td>
                                            ...
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <a class=""
                                                            href="<?php echo e(route('purchasedetails.items', $record->fld_prid)); ?>">
                                                            <i class="ri-eye-line"></i></a>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(route('purchasedetails.delete', $record->fld_prid)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u951376346/domains/nebulacrm.in/public_html/himalaya/resources/views/purchasedetail.blade.php ENDPATH**/ ?>