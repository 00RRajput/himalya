        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('stockists')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <?php if($record->purchase_sum_fld_total): ?>
                                                        <a
                                                            href="<?php echo e(route('purchasedetails', ['sid' => $record->fld_sid])); ?>">
                                                            <i class="ri-eye-line"></i></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(route('stockists.addneworder', ['sid' => $record->fld_sid])); ?>"
                                                        data-id="25000351"><i class="ri-add-box-fill text-muted"></i>
                                                    </a>
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(route('stockists.delete', $record->fld_sid)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u951376346/domains/nebulacrm.in/public_html/himalaya/resources/views/stockists.blade.php ENDPATH**/ ?>