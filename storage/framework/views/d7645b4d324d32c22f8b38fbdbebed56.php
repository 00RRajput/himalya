...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        Approved Installation ( Total : <?php echo e(count($records)); ?> )
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/branding/installation-approved')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                            ...
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                <thead class="text-muted">
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Install Image 1 </th>
                                        <th class="text-uppercase">Install Image 2 </th>
                                            ...
                                            <?php if($record->fld_image): ?>
                                                    <a class="image-popup"
                                                        ...
                                                        <img class="gallery-img img-fluid mx-auto avatar-xs rounded me-2"
                                                            ...
                                                            alt="<?php echo e($record->fld_image); ?>">
                                                    </a>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/branding/installationapprove.blade.php ENDPATH**/ ?>