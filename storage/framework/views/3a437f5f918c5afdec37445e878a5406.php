                        ...
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="table-row" data-row-id=<?php echo e($record->fld_csid); ?>>
                                            ...
                                            <td class="td">
                                                <input id="product_qty_<?php echo e($record->fld_csid); ?>"
                                                    data-record-id="<?php echo e($record->fld_csid); ?>"
                                            ...
                                            <td class="td"><input readonly id="product_total_<?php echo e($record->fld_csid); ?>"
                                            ...
                                            <td>
                                                <?php if(in_array(Auth::user()->fld_role, [1, 3, 5])): ?>
                                                    <a class="bx bx-trash removeProduct" href="javascript:void(0)"
                                                        data-id="<?php echo e($record->fld_csid); ?>"></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php
                            ...
                            <table class="table align-middle table-nowrap">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="hidden" id="fld_csid" value="<?php echo e($consumerSale->fld_csid); ?>" />
                                            ...
                                            <a class="btn btn-danger" href="<?php echo e(route('van.consumersales')); ?>">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('van.consumerSales.details.update')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/consumersaledetails.blade.php ENDPATH**/ ?>