<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Branding Route Plans'); ?>
                ...
                <div class="p-3">
                    <div class="gap-2 d-flex justify-content-end ">
                        <?php if(in_array(Auth::user()->fld_role, [1])): ?>
                            <a class="btn  btn-success btn-sm" href="<?php echo e(url('/branding/upload/route-plans')); ?>"
                        ...
                        <a class="btn  btn-primary btn-sm" href="<?php echo e(route('branding.create.routePlans')); ?>"
                            style="float: right;right:0px">Add Route Plan</a>
                    </div>
                </div>
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/branding/route-plan')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a class=""
                                                        href="<?php echo e(route('branding.edit.routePlans', $record->fld_rpid)); ?>">
                                                        <i class="ri-edit-line"></i></a>
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(route('branding.delete.routePlans', $record->fld_rpid)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/branding/routeplans.blade.php ENDPATH**/ ?>