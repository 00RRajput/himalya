<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Recce Pending'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        Pending Recce ( Total : <?php echo e(count($records)); ?> )
        <?php $__env->endSlot(); ?>
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/branding/recce-pending')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                           ...
                           <div class="col">
                                <div class="d-flex gap-2">
                                    ...
                                    <a class="btn btn-secondary col ml-1" href="<?php echo e(url('purchase-details')); ?>">Reset</a>
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="td">
                                            <?php if($record->fld_photo_file_recce): ?>
                                                    <a class="image-popup"
                                                        href="<?php echo e(env('SERVER_BASE_URL')); ?><?php echo e($record->fld_photo_path_recce); ?>/<?php echo e($record->fld_photo_file_recce); ?>"
                                                        title="<?php echo e($record->fld_photo_path_recce); ?>">
                                                        <img class="gallery-img img-fluid mx-auto avatar-xs rounded me-2"
                                                            src="<?php echo e(env('SERVER_BASE_URL')); ?><?php echo e($record->fld_photo_path_recce); ?>/<?php echo e($record->fld_photo_file_recce); ?>"
                                                            alt="<?php echo e($record->fld_photo_path_recce); ?>">
                                                    </a>
                                                <?php else: ?>
                                             ...
                                             <td>
                                                ...
                                                <a href="<?php echo e(route('branding.images', ['id'=> $record->fld_raid, 'type'=> 'recce'])); ?>" style="font-size:11px;">View All Images</a>
                                                <?php endif; ?>
                                            </td>
                                           
                                            <td class="td">
                                                <?php if($record->fld_recce_date): ?>
                                                <?php echo e(date(env('DATE_FORMAT'), strtotime($record->fld_recce_date))); ?>
                                            ...
                                            <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                               <td>
                                                    ...
                                                    <a href="<?php echo e(route('branding.recce.approve', $record->fld_raid)); ?>" onclick="return confirm('Are you sure you want to approve?')"><button type="button" class="btn btn-success">Approve</button></a>
                                                    <a href="<?php echo e(route('branding.recce.reject', $record->fld_raid)); ?>" onclick="return confirm('Are you sure you want to reject?')"><button type="button" class="btn btn-danger">Reject</button></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/branding/reccepending.blade.php ENDPATH**/ ?>