        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body  bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(route('branding.routePlan.upload')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <!--end col-->
                            <div class="row">
                                <div class="col-4">
                                    <select id="project_id" name="project_id"
                                        ...
                                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($project->fld_pid); ?>" <?php if($project->fld_pid == 4): ?> selected <?php endif; ?>> <?php echo e($project->fld_name); ?> </option>
                                ...
                                <div class="col-4">
                                    <div class="d-flex gap-1">
                                        ...
                                        <a target="_blank" href="/uploads/Sample-Branding.xlsx"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/branding/uploadroute.blade.php ENDPATH**/ ?>