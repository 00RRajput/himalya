<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Van Route Plans'); ?>
                ...
                <div class="p-3">
                    <div class="gap-2 d-flex justify-content-end ">
                        <?php if(in_array(Auth::user()->fld_role, [1])): ?>
                            <a class="btn  btn-success btn-sm" href="<?php echo e(url('/van/upload/route')); ?>"
                        ...
                        <a class="btn  btn-primary btn-sm" href="<?php echo e(route('master.create.routePlans')); ?>"
                            style="float: right;right:0px">Add Route Plan</a>
                    </div>
                </div>
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="<?php echo e(url('/van/route-plan')); ?>" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                            ...
                            <table class="table align-middle table-nowrap" id="">
                                <thead class="text-muted">
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Village Name</th>
                                ...
                                <tbody class="list form-check-all" id="">
                                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="td"><?php echo e($record->district_name); ?></td>
                                            <td class="td"><?php echo e($record->fld_tehsil); ?></td>
                                            <td class="td"><?php echo e($record->village_name); ?></td>
                                            <td class="td"><?php echo e($record->fld_user); ?></td>
                                            <td class="td">
                                                <div class="d-flex gap-2">

                                                    <a class=""
                                                        href="<?php echo e(route('master.edit.routePlans', $record->fld_rpid)); ?>">
                                                        <i class="ri-edit-line"></i></a>
                                                    <?php if(in_array(Auth::user()->fld_role, [1, 3])): ?>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="<?php echo e(route('master.delete.routePlans', $record->fld_rpid)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dr.mac/Downloads/himalaya/resources/views/routeplans.blade.php ENDPATH**/ ?>