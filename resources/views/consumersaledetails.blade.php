                        ...
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    @forelse ($records as $record)
                                        <tr class="table-row" data-row-id={{ $record->fld_csid }}>
                                            ...
                                            <td class="td">
                                                <input id="product_qty_{{ $record->fld_csid }}"
                                                    data-record-id="{{ $record->fld_csid }}"
                                            ...
                                            <td class="td"><input readonly id="product_total_{{ $record->fld_csid }}"
                            ...
                            <table class="table align-middle table-nowrap">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="hidden" id="fld_csid" value="{{ $consumerSale->fld_csid }}" />
                                            ...
                                            <a class="btn btn-danger" href="{{route('van.consumersales')}}">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "{{ route('van.consumerSales.details.update') }}",
                    type: "POST",
