        <form action="{{ route('products.store') }}" method="POST" name="add_new_record">
            @csrf
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="@error('fld_sku')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('fld_sku') }}" type="text"
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="@error('fld_mrp')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('fld_mrp') }}" type="text"
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="@error('fld_cost_price')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('fld_cost_price') }}" type="text"
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="@error('fld_selling_price')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('fld_selling_price') }}"
