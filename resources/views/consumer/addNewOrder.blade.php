                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <input type="hidden" id="fld_cid" value="{{ $consumer->fld_cid ?? 0 }}" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="{{ $consumer->fld_mobile_id ?? 0 }}" />
                                            @if (in_array(Auth::user()->fld_role, [1, 3, 5]))
                                                <a class="btn btn-success" id="updateItems"
                                                    href="javascript:void(0)">Submit</a>
                                            @endif
                                            <a class="btn btn-danger" href="{{route('van.consumer')}}">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "{{ route('consumer.createNewOrder') }}",
                    type: "POST",
