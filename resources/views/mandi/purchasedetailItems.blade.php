                        ...
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    @forelse ($records as $record)
                                        <tr class="table-row" data-row-id={{ $record->fld_prid }}>

                                            <td class="td">
                                                <span class="row_product_id"
                                                    data-product-name="{{ $record->fld_product_name }}"
                                                    data-product-id={{ $record->fld_product_id }}>
                                                    {{ $record->fld_product_name }}- {{ $record->fld_selling_price }}
                                                    (MRP Rs.{{ $record->fld_mrp }})
                                                </span>
                                            </td>
                                            <td class="td">
                                                <input id="product_qty_{{ $record->fld_prid }}"
                                                    data-record-id="{{ $record->fld_prid }}"
                            ...
                            <table class="table align-middle table-nowrap">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="hidden" id="fld_prid" value="{{ $purchases->fld_prid }}" />
                                            <input type="hidden" id="fld_project_id"
                                                value="{{ $purchases->fld_project_id }}" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="{{ $purchases->fld_mobile_id }}" />
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "{{ route('mandi.purchasedetails.item.udate') }}",
                    type: "POST",
