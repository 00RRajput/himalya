        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('mandi.stockists') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                ...
                                <tbody class="list form-check-all" id="">
                                    @forelse ($records as $key=> $record)
                                        <tr>
                                            ...
                                            <td class="td">
                                                <p class="mb-0 text-capitalize">{{ $record->fld_firm_name }}</p>
                                                <p class="text-muted mb-0 text-capitalize">{{ $record->fld_stockist_name }}
                                                </p>
                                                <p class="text-muted mb-0">{{ $record->stockist_number }}</p>
                                            </td>
                                            <td class="td">
                                                {{ $record->fld_district }}
                                            ...
                                            <td class="td">{{ $record->purchase_sum_fld_total ?? 0 }}
                                            <td class="td">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if ($record->purchase_sum_fld_total)
                                                        <a
                                                            href="{{ route('mandi.purchasedetails.items', $record->fld_sid) }}">
                                                            <i class="ri-eye-line"></i></a>
                                                    @endif
                                                    <a href="{{ route('mandi.stockists.addneworder', ['sid' => $record->fld_sid]) }}"
                                                        data-id="25000351"><i class="ri-add-box-fill text-muted"></i>
                                                    </a>
                                                    @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                        {{--<form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="{{ route('mandi.stockists.delete', $record->fld_sid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
