        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('mandi/retailers') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if ($record->retail_sale_count_sum_fld_total)
                                                        <a href="{{ route('mandi.retailsales', ['rid' => $record->fld_rid]) }}"
                                                            data-id="25000351"><i class="ri-eye-fill text-muted"></i>
                                                        </a>
                                                     @endif
                                                    <a href="{{ route('mandi.retailsales.addnew', ['rid' => $record->fld_rid]) }}"
                                                        data-id="25000351"><i class="ri-add-box-fill text-muted"></i>
                                                    </a>
                                                    @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="{{ url('/mandi/retailer/delete/'.$record->fld_rid) }}"
                                                            method="GET">
                                                            @csrf
                                                            @method('GET')
