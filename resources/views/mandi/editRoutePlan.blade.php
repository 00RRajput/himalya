    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                @endif
                <form action="{{ route('mandi.update.routePlans', $routePlan->fld_rpid) }}" method="POST" name="add_new">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="live-preview">
                            <input type="hidden" name="fld_project_id" value="{{$routePlan->fld_pid}}">
                            <div class="row">
                                <!--end col-->
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="district_id" id="district_id"
                                        ...
                                        @foreach ($destrict as $dis)
                                            <option value="{{ $dis->fld_did }}" @selected($routePlan->fld_district_id == $dis->fld_did)>
                                                {{ $dis->fld_district }}</option>
                                        @endforeach
                                    </select>
                                </div> 
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="fld_tid" id="fld_tid"
                                        ...
                                        @foreach ($towns as $town)
                                                    <option value="{{ $town->fld_tid }}" @selected($routePlan->fld_town_id == $town->fld_tid)>
                                ...
                                <label for="user_id" class="form-control-label">Mandi<sup>*</sup></label>
                                    <select id="mandi_id" name="mandi_id"
                                        ...
                                        @foreach ($mandis as $mandi)
                                                    <option value="{{ $mandi->fld_mid }}" @selected($routePlan->fld_mandi_id == $mandi->fld_mid)>
                                ...
                                <label for="user_id" class="form-control-label">Wholesalers<sup>*</sup></label>
                                    <select name="wholesaler_id" id="wholesaler_id"
                                        ...
                                        @foreach ($wholesalers as $w)
                                                    <option value="{{ $w->fld_wsid }}" @selected($routePlan->fld_wsid == $w->fld_wsid)>
