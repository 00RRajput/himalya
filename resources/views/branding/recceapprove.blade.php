...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('titleHeading')
        Approved Recce ( Total : {{ count($records) }} )
        @endslot
        @slot('title')
            Recce Approve
        @endslot
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('/branding/recce-approved') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                    ...
                                    @forelse ($records as $key=> $record)
                                        <tr>
                                            ...
                                            @if (in_array(Auth::user()->fld_role, [1, 3]))
                                               <td>
                                                    <div class="d-flex gap-2">
                                                    <a href="{{ route('branding.recce.reject', $record->fld_raid) }}" onclick="return confirm('Are you sure you want to reject?')"><button type="button" class="btn btn-danger">Reject</button></a>
                                                    {{--  <a class=""
