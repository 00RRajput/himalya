    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                @endif
                <form action="{{ route('branding.store.routePlans') }}" method="POST" name="add_new">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 mb-3">
                                    <select name="town_id" id="town_id"
                                        ...
                                        <option value="{{$town->fld_tid}}">{{$town->fld_town}} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-4 mb-3">
                                    <select name="outlet_id" id="town_id"
                                        ...
                                        <option value="{{$outlet->fld_oid}}">{{$outlet->fld_outlet}} </option>
                                        @endforeach
                                    </select>
                                </div>
