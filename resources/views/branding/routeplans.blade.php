                ...
                <div class="p-3">
                    <div class="gap-2 d-flex justify-content-end ">
                        @if (in_array(Auth::user()->fld_role, [1]))
                            <a class="btn  btn-success btn-sm" href="{{ url('/branding/upload/route-plans') }}"
                        ...
                        <a class="btn  btn-primary btn-sm" href="{{ route('branding.create.routePlans') }}"
                            style="float: right;right:0px">Add Route Plan</a>
                    </div>
                </div>
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('/branding/route-plan') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a class=""
                                                        href="{{ route('branding.edit.routePlans', $record->fld_rpid) }}">
                                                        <i class="ri-edit-line"></i></a>
                                                    @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="{{ route('branding.delete.routePlans', $record->fld_rpid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
