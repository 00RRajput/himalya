        <form action="{{ route('village.store') }}" method="POST" name="add_new_record">
            @csrf

            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Add New Village</h4>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="@error('fld_village')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('fld_village') }}" type="text"
                                            placeholder="Enter  name" id="fld_village" name="fld_village" required>
                                        @error('fld_district')
