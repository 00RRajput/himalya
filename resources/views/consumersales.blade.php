...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('titleHeading')
            Van Consumer Sales (Total Orders: {{ $records->total() }} , Order Value: ₹ {{ $total_order_value }})
        @endslot
        @slot('title')
            @lang('Van Consumer Sales')
        @endslot
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('sales-report/consumer-sales') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="d-flex gap-2">
                                    ...
                                    <a class="btn btn-secondary col ml-1"
                                        href="{{ url('sales-report/consumer-sales') }}">Reset</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a class=""
                                                        href="{{ route('van.consumersales.details', $record->fld_csid) }}">
                                                        <i class="ri-eye-line"></i></a>
                                                    @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="{{ route('van.consumerSales.delete', $record->fld_csid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
