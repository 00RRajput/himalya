...
@section('content')
    ...
    <div class="row">
                                ...
                                <tbody class="list form-check-all" id="">
                                    @forelse ($records as $key => $record)
                                        <tr>
                                            ...
                                            <td class="td">{{ $record->fld_purpose }}</td>
                                            ...
                                            <td class="d-flex gap-2">
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('phototypes.edit', $record->fld_ptid) }}">Edit</a>

                                                <form action="{{ route('phototypes.destroy', $record->fld_ptid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="col-lg-4">
            @if (request()->route()->getName() === 'phototypes.edit')
                @include('phototype.edit', ['phototype' => $phototype])
            @else
                @include('phototype.create')
            @endif
