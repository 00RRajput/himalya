                                    ...
                                    <tr> 
                                        <td colspan="5">
                                            <input type="hidden" id="fld_rsid"
                                                value="{{ $retailSale->fld_rsid ?? 0 }}" />
                                            <input type="hidden" id="fld_rid" value="{{ $retailer->fld_rid ?? 0 }}" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="{{ $retailSale->fld_mobile_id ?? 0 }}" />
                                            @if (in_array(Auth::user()->fld_role, [1, 3, 5]))
                                                <a class="btn btn-success" id="updateItems"
                                                    href="javascript:void(0)">Submit</a>
                                            @endif
                                            <a class="btn btn-danger" href="{{route('van.retailers')}}">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "{{ route('salesreport.retailsales.createNewOrder') }}",
                    type: "POST",
