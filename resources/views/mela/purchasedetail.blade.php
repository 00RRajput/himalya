...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('titleHeading')
            Mela PURCHASE DETAILS (Total Orders: {{ $records->total() }} , Order Value: ₹ {{ $total_order_value }})
        @endslot
        @slot('title')
            PURCHASE DETAILS
        @endslot
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('mela.purchase') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                            ...
                                            @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <a class=""
                                                            href="{{ route('mela.purchasedetails.items', $record->fld_prid) }}">
                                                            <i class="ri-eye-line"></i></a>
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="{{ route('mela.purchasedetails.delete', $record->fld_prid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
