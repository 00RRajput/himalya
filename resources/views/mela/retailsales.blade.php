...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('titleHeading')
            Mandi RETAILS SALES (Total Orders: {{ $records->total() }} , Order Value: ₹ {{ $total_order_value }})
        @endslot
        @slot('title')
        Mandi RETAILS SALES
        @endslot
        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('mandi/retail-sales') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                            ...
                            <table class="table align-middle table-nowrap" id="">
                                <thead class="text-muted">
                                    <tr>
                                        ...
                                        <th class="text-uppercase">Distt.</th>
                                ...
                                <tbody class="list form-check-all" id="">
                                    @forelse ($records as $key=> $record)
                                        <tr>
                                            ...
                                            <td>{{ $record->fld_district }}</td>
                                            <td>{{ $record->fld_town }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a class=""
                                                        href="{{ route('mandi.retailsales.details', $record->fld_rsid) }}">
                                                        <i class="ri-eye-line"></i></a>
                                                    @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                        <form onsubmit="return confirm('Do you really want to delete?');"
                                                            action="{{ route('mandi.retailsales.delete', $record->fld_rsid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
