        ...
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                ...
                <div class="card-body bg-soft-light border border-dashed border-start-0 border-end-0">
                    <form action="{{ url('/mela/consumer') }}" method="GET">
                        <div class="row g-3">
                            <!--end col-->
                            <div class="col">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if ($record->fld_total)
                                                        <a class=""
                                                            href="{{ route('mela.consumersales.details', $record->fld_mcid) }}">
                                                            <i class="ri-eye-line"></i></a>
                                                    @endif
                                                    <a href="{{ route('mela.consumersales.addnew', ['mcid' => $record->fld_mcid]) }}"
                                                    ...
                                                    @if (in_array(Auth::user()->fld_role, [1, 3]))
                                                        <form
                                                            ...
                                                            action="{{ route('mela.consumer.destroy', $record->fld_mcid) }}"
                                                            method="GET">
                                                            @csrf
                                                            @method('GET')
