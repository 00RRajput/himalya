                        ...
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    @forelse ($records as $record)
                                        <tr class="table-row" data-row-id={{ $record->fld_mrsiid }}>
                                            ...
                                            <td class="td">
                                                <input id="product_qty_{{ $record->fld_mrsiid }}"
                                                    data-record-id="{{ $record->fld_mrsiid }}"
                                            ...
                                            <td class="td"><input readonly id="product_total_{{ $record->fld_mrsiid }}"
                            ...
                            <table class="table align-middle table-nowrap">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="hidden" id="fld_rsid" value="{{ $retailSale->fld_rsid }}" />
                                            <input type="hidden" id="fld_mobile_id"
                                                value="{{ $retailSale->fld_mobile_id }}" />
                                            @if (in_array(Auth::user()->fld_role, [1, 3, 5]))
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "{{ route('mandi.retailsales.details.update') }}",
                    type: "POST",
