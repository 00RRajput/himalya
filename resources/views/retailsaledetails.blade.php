                            ...
                            <table class="table align-middle table-nowrap" id="purchase-details">
                                ...
                                <tbody class="list form-check-all" id="table-tr">
                                    ...
                                    @forelse ($records as $record)
                                        <tr class="table-row" data-row-id={{ $record->fld_rsiid }}>
                                            ...
                                            <td class="td">
                                                <input id="product_qty_{{ $record->fld_rsiid }}"
                                                    data-record-id="{{ $record->fld_rsiid }}"
                                            ...
                                            <td class="td"><input readonly id="product_total_{{ $record->fld_rsiid }}"
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            ...
                                            <a class="btn btn-danger" href="{{session('retsil-route')}}">Cancel</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#updateItems").click(function() {
                ...
                $.ajax({
                    url: "{{ route('salesreport.retailsales.details.update') }}",
                    type: "POST",
