...
class PurchaseDetailController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('purchasedetail', compact('records', 'projects', 'users', 'states', 'total_order_value'));
    }
    ...
    public function getStockists(Request $request)
    {
        ...
        return view('stockists', compact('records', 'projects', 'users', 'states', 'districts'));
    }
    ...
    public function addNewStockistOrder(Request $request)
    {
        ...
        return view('stockiestAddNewOrder', compact('products', 'stockist'));
    }
    ...
    public function getPurchaseDetails($id)
    {
        ...
        return view('purchasedetailItems', compact('records', 'products', 'purchases'));
    }
    ...
    public function activityPhoto(Request $request)
    {
        ...
        // dd($records);
        return view('activityPhoto', compact('records', 'projects', 'users', 'states', 'districts'));
    }
